...
The plugin ships a simulator that builds a throwaway repo with fake build tools and drives the real hooks and CLI through 189 scenarios:

```bash
node bin/keel simulate            # run every scenario (189)
