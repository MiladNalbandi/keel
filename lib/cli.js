...
function huntCmd(args = []) {
  ...
  return fail(`unknown hunt command "${sub}". Use start, lenses, add, prove, group, report, next, close, list or status.`);
}
...
module.exports = { init, stateCmd, commit, gate, escalate, traceCmd, auditCmd, status, verifyCmd, unlock, env,
  parseOpts, positionals, triggers, ladderCmd, FLOW_START, huntCmd, discoverCmd, scaffoldCmd, stackCmd, laneCmd, smokeCmd, prCmd, triageCmd, checkSizeCmd,
