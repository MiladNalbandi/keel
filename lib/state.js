...
const PHASES = ['none', 'setup', 'preflight', 'workspace', 'triage', 'spec', 'plan', 'contract',
  ...
  'bug-fix', 'reset', 'ship', 'final-review'];
...
const TRANSITIONS = {
  ...
  ship: ['coverage-fix', 'review-fix', 'red', 'gate', 'final-review', 'none'],
  'final-review': ['ship', 'none'],
};
...
module.exports = { EMPTY, PHASES, TRANSITIONS, LADDER, canTransition, read, write, update, active,
  recordFailure, clearStall, stalled, nextLadderStep, acList, acSummary, file };
