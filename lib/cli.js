...
const FLOW_START = { feature: 'spec', change: 'triage', fix: 'bug-report' };
...
module.exports = { init, stateCmd, commit, gate, escalate, traceCmd, auditCmd, status, verifyCmd, unlock, env,
  parseOpts, triggers, ladderCmd, FLOW_START, discoverCmd, scaffoldCmd, stackCmd, laneCmd, smokeCmd, prCmd, triageCmd, checkSizeCmd,
