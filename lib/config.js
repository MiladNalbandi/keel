...
const DEFAULTS = {
  ...
  hunt: {
    ...
    lenses: ['security', 'behavioral', 'technical', 'contract-drift', 'test-integrity', 'data-migration'],
    default_scope: 'diff',
  ...
  setup: {
    ladder: ['toolchain', 'dependencies', 'compile', 'unit-tests', 'testcontainers',
      'services', 'api-boot', 'web-boot', 'smoke', 'hooks'],
