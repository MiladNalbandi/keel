...
function huntCmd(args = []) {
  ...
  return fail(`unknown hunt command "${sub}". Use start, lenses, add, list or status.`);
}
...
module.exports = { init, stateCmd, commit, gate, escalate, traceCmd, auditCmd, status, verifyCmd, unlock, env,
  parseOpts, triggers, ladderCmd, FLOW_START, huntCmd, discoverCmd, scaffoldCmd, stackCmd, laneCmd, smokeCmd, prCmd, triageCmd, checkSizeCmd,
